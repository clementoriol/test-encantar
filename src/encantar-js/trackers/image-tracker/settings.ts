...
export const SCAN_RANSAC_REPROJECTIONERROR_NDC =
  SCAN_RANSAC_REPROJECTIONERROR_NIS / (NIS_SIZE / 2);
...
export const PRE_TRACK_RANSAC_REPROJECTIONERROR_NIS =
  (NIS_SIZE * 0.0125 * 0.5) | 0;

/** Reprojection error, in NDC, used when pre-tracking */
export const PRE_TRACK_RANSAC_REPROJECTIONERROR_NDC =
  PRE_TRACK_RANSAC_REPROJECTIONERROR_NIS / (NIS_SIZE / 2);
...
export const TRACK_CLIPPING_BORDER = TRACK_RECTIFIED_BORDER * 1.2; //1.25; //1.15;
...
export const TRACK_RANSAC_REPROJECTIONERROR_NDC =
  TRACK_RANSAC_REPROJECTIONERROR_NIS / (NIS_SIZE / 2);
